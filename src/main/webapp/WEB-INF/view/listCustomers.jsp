...
<div class="container d-flex flex-column justify-content-center">
    ...
    <div class="p-2">
        <div class="d-flex flex-column justify-content-center">
            ...
            <div class="p-2"><a id='addCustomer' href="showCustomerAddForm" type="button" class="btn btn-light rounded m-2">Add
                new customer</a></div>
    ...
    <div class="p-2">
        <table class="table">
            ...
            <tr>
                ...
                <th>Middle Name</th>
                <th>Sex</th>
                <th>Actual address id</th>
                <th>Registered address id</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach var="tempCustomer" items="${customers}">
                ...
                <c:url var="updateLink" value="/customer/showCustomerFormUpdate">
